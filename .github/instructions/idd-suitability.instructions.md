...
The numeric `<!-- web-toybox-autopilot-suitability: N -->`
...
`<!-- web-toybox-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- web-toybox-triage-verdict: <outcome> -->
```
...
`web-toybox-triage-verdict` marker. Apply the same
