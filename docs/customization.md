...
| ------------------------------------------------------------------- | -------------------------------- |
| `idd-skill` in repo-name contexts                                   | `web-toybox`                  |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `web-toybox`      |
...
| **install-deps** command string                                     | `corepack enable && pnpm install --prefer-frozen-lockfile`       |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `web-toybox` to support
